...
`)+`
`+p);let y=v+m+a,_=v+p+o,T=Pu(i,i.VERTEX_SHADER,y),w=Pu(i,i.FRAGMENT_SHADER,_);i.attachShader(b,T),i.attachShader(b,w),t.index0AttributeName!==void 0?i.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(b,0,"position"),i.linkProgram(b);function C(I){if(s.debug.checkShaderErrors){let B=i.getProgramInfoLog(b)||"",z=i.getShaderInfoLog(T)||"",V=i.getShaderInfoLog(w)||"",j=B.trim(),N=z.trim(),W=V.trim(),F=!0,Z=!0;if(i.getProgramParameter(b,i.LINK_STATUS)===!1)if(F=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,b,T,w);else{let K=Du(i,T,"vertex"),ce=Du(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(b,i.VALIDATE_STATUS)+`
...
Program Info Log: `+j+`
`+K+`
`+ce)}else j!==""?console.warn("THREE.WebGLProgram: Program Info Log:",j):(N===""||W==="")&&(Z=!1);Z&&(I.diagnostics={runnable:F,programLog:j,vertexShader:{log:N,prefix:m},fragmentShader:{log:W,prefix:p}})}i.deleteShader(T),i.deleteShader(w),D=new Es(i,b),S=hb(i,b)}let D;this.getUniforms=function(){return D===void 0&&C(this),D};let S;this.getAttributes=function(){return S===void 0&&C(this),S};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=i.getProgramParameter(b,tb)),M},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(b),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=nb++,this.cacheKey=e,this.usedTimes=1,this.program=b,this.vertexShader=T,this.fragmentShader=w,this}var Mb=0,$c=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){let t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(i)===!1&&(a.add(i),i.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){let t=this.shaderCache,n=t.get(e);return n===void 0&&(n=new Qc(e),t.set(e,n)),n}},Qc=class{constructor(e){this.id=Mb++,this.code=e,this.usedTimes=0}};function Sb(s,e,t,n,i,r,a){let o=new rs,l=new $c,c=new Set,h=[],u=i.logarithmicDepthBuffer,d=i.vertexTextures,f=i.precision,g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function b(S){return c.add(S),S===0?"uv":`uv${S}`}function m(S,M,I,B,z){let V=B.fog,j=z.geometry,N=S.isMeshStandardMaterial?B.environment:null,W=(S.isMeshStandardMaterial?t:e).get(S.envMap||N),F=W&&W.mapping===pr?W.image.height:null,Z=g[S.type];S.precision!==null&&(f=i.getMaxPrecision(S.precision),f!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",f,"instead."));let K=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,ce=K!==void 0?K.length:0,J=0;j.morphAttributes.position!==void 0&&(J=1),j.morphAttributes.normal!==void 0&&(J=2),j.morphAttributes.color!==void 0&&(J=3);let ne,Fe,be,q;if(Z){let tt=Cn[Z];ne=tt.vertexShader,Fe=tt.fragmentShader}else ne=S.vertexShader,Fe=S.fragmentShader,l.update(S),be=l.getVertexShaderID(S),q=l.getFragmentShaderID(S);let $=s.getRenderTarget(),le=s.state.buffers.depth.getReversed(),Re=z.isInstancedMesh===!0,pe=z.isBatchedMesh===!0,Oe=!!S.map,et=!!S.matcap,P=!!W,Ye=!!S.aoMap,De=!!S.lightMap,Ae=!!S.bumpMap,ge=!!S.normalMap,Ze=!!S.displacementMap,Me=!!S.emissiveMap,Ve=!!S.metalnessMap,Tt=!!S.roughnessMap,gt=S.anisotropy>0,A=S.clearcoat>0,x=S.dispersion>0,k=S.iridescence>0,Y=S.sheen>0,ee=S.transmission>0,X=gt&&!!S.anisotropyMap,we=A&&!!S.clearcoatMap,ae=A&&!!S.clearcoatNormalMap,Se=A&&!!S.clearcoatRoughnessMap,Ee=k&&!!S.iridescenceMap,se=k&&!!S.iridescenceThicknessMap,fe=Y&&!!S.sheenColorMap,Ne=Y&&!!S.sheenRoughnessMap,Te=!!S.specularMap,ue=!!S.specularColorMap,Ge=!!S.specularIntensityMap,L=ee&&!!S.transmissionMap,re=ee&&!!S.thicknessMap,oe=!!S.gradientMap,_e=!!S.alphaMap,te=S.alphaTest>0,Q=!!S.alphaHash,ye=!!S.extensions,ke=jn;S.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(ke=s.toneMapping);let ot={shaderID:Z,shaderType:S.type,shaderName:S.name,vertexShader:ne,fragmentShader:Fe,defines:S.defines,customVertexShaderID:be,customFragmentShaderID:q,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:f,batching:pe,batchingColor:pe&&z._colorsTexture!==null,instancing:Re,instancingColor:Re&&z.instanceColor!==null,instancingMorph:Re&&z.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:$===null?s.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:Ct,alphaToCoverage:!!S.alphaToCoverage,map:Oe,matcap:et,envMap:P,envMapMode:P&&W.mapping,envMapCubeUVHeight:F,aoMap:Ye,lightMap:De,bumpMap:Ae,normalMap:ge,displacementMap:d&&Ze,emissiveMap:Me,normalMapObjectSpace:ge&&S.normalMapType===iu,normalMapTangentSpace:ge&&S.normalMapType===Dc,metalnessMap:Ve,roughnessMap:Tt,anisotropy:gt,anisotropyMap:X,clearcoat:A,clearcoatMap:we,clearcoatNormalMap:ae,clearcoatRoughnessMap:Se,dispersion:x,iridescence:k,iridescenceMap:Ee,iridescenceThicknessMap:se,sheen:Y,sheenColorMap:fe,sheenRoughnessMap:Ne,specularMap:Te,specularColorMap:ue,specularIntensityMap:Ge,transmission:ee,transmissionMap:L,thicknessMap:re,gradientMap:oe,opaque:S.transparent===!1&&S.blending===gi&&S.alphaToCoverage===!1,alphaMap:_e,alphaTest:te,alphaHash:Q,combine:S.combine,mapUv:Oe&&b(S.map.channel),aoMapUv:Ye&&b(S.aoMap.channel),lightMapUv:De&&b(S.lightMap.channel),bumpMapUv:Ae&&b(S.bumpMap.channel),normalMapUv:ge&&b(S.normalMap.channel),displacementMapUv:Ze&&b(S.displacementMap.channel),emissiveMapUv:Me&&b(S.emissiveMap.channel),metalnessMapUv:Ve&&b(S.metalnessMap.channel),roughnessMapUv:Tt&&b(S.roughnessMap.channel),anisotropyMapUv:X&&b(S.anisotropyMap.channel),clearcoatMapUv:we&&b(S.clearcoatMap.channel),clearcoatNormalMapUv:ae&&b(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Se&&b(S.clearcoatRoughnessMap.channel),iridescenceMapUv:Ee&&b(S.iridescenceMap.channel),iridescenceThicknessMapUv:se&&b(S.iridescenceThicknessMap.channel),sheenColorMapUv:fe&&b(S.sheenColorMap.channel),sheenRoughnessMapUv:Ne&&b(S.sheenRoughnessMap.channel),specularMapUv:Te&&b(S.specularMap.channel),specularColorMapUv:ue&&b(S.specularColorMap.channel),specularIntensityMapUv:Ge&&b(S.specularIntensityMap.channel),transmissionMapUv:L&&b(S.transmissionMap.channel),thicknessMapUv:re&&b(S.thicknessMap.channel),alphaMapUv:_e&&b(S.alphaMap.channel),vertexTangents:!!j.attributes.tangent&&(ge||gt),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,pointsUvs:z.isPoints===!0&&!!j.attributes.uv&&(Oe||_e),fog:!!V,useFog:S.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:S.flatShading===!0&&S.wireframe===!1,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:le,skinning:z.isSkinnedMesh===!0,morphTargets:j.morphAttributes.position!==void 0,morphNormals:j.morphAttributes.normal!==void 0,morphColors:j.morphAttributes.color!==void 0,morphTargetsCount:ce,morphTextureStride:J,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:s.shadowMap.enabled&&I.length>0,shadowMapType:s.shadowMap.type,toneMapping:ke,decodeVideoTexture:Oe&&S.map.isVideoTexture===!0&&Ke.getTransfer(S.map.colorSpace)===it,decodeVideoTextureEmissive:Me&&S.emissiveMap.isVideoTexture===!0&&Ke.getTransfer(S.emissiveMap.colorSpace)===it,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===It,flipSided:S.side===Pt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:ye&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ye&&S.extensions.multiDraw===!0||pe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return ot.vertexUv1s=c.has(1),ot.vertexUv2s=c.has(2),ot.vertexUv3s=c.has(3),c.clear(),ot}function p(S){let M=[];if(S.shaderID?M.push(S.shaderID):(M.push(S.customVertexShaderID),M.push(S.customFragmentShaderID)),S.defines!==void 0)for(let I in S.defines)M.push(I),M.push(S.defines[I]);return S.isRawShaderMaterial===!1&&(v(M,S),y(M,S),M.push(s.outputColorSpace)),M.push(S.customProgramCacheKey),M.join()}function v(S,M){S.push(M.precision),S.push(M.outputColorSpace),S.push(M.envMapMode),S.push(M.envMapCubeUVHeight),S.push(M.mapUv),S.push(M.alphaMapUv),S.push(M.lightMapUv),S.push(M.aoMapUv),S.push(M.bumpMapUv),S.push(M.normalMapUv),S.push(M.displacementMapUv),S.push(M.emissiveMapUv),S.push(M.metalnessMapUv),S.push(M.roughnessMapUv),S.push(M.anisotropyMapUv),S.push(M.clearcoatMapUv),S.push(M.clearcoatNormalMapUv),S.push(M.clearcoatRoughnessMapUv),S.push(M.iridescenceMapUv),S.push(M.iridescenceThicknessMapUv),S.push(M.sheenColorMapUv),S.push(M.sheenRoughnessMapUv),S.push(M.specularMapUv),S.push(M.specularColorMapUv),S.push(M.specularIntensityMapUv),S.push(M.transmissionMapUv),S.push(M.thicknessMapUv),S.push(M.combine),S.push(M.fogExp2),S.push(M.sizeAttenuation),S.push(M.morphTargetsCount),S.push(M.morphAttributeCount),S.push(M.numDirLights),S.push(M.numPointLights),S.push(M.numSpotLights),S.push(M.numSpotLightMaps),S.push(M.numHemiLights),S.push(M.numRectAreaLights),S.push(M.numDirLightShadows),S.push(M.numPointLightShadows),S.push(M.numSpotLightShadows),S.push(M.numSpotLightShadowsWithMaps),S.push(M.numLightProbes),S.push(M.shadowMapType),S.push(M.toneMapping),S.push(M.numClippingPlanes),S.push(M.numClipIntersection),S.push(M.depthPacking)}function y(S,M){o.disableAll(),M.supportsVertexTextures&&o.enable(0),M.instancing&&o.enable(1),M.instancingColor&&o.enable(2),M.instancingMorph&&o.enable(3),M.matcap&&o.enable(4),M.envMap&&o.enable(5),M.normalMapObjectSpace&&o.enable(6),M.normalMapTangentSpace&&o.enable(7),M.clearcoat&&o.enable(8),M.iridescence&&o.enable(9),M.alphaTest&&o.enable(10),M.vertexColors&&o.enable(11),M.vertexAlphas&&o.enable(12),M.vertexUv1s&&o.enable(13),M.vertexUv2s&&o.enable(14),M.vertexUv3s&&o.enable(15),M.vertexTangents&&o.enable(16),M.anisotropy&&o.enable(17),M.alphaHash&&o.enable(18),M.batching&&o.enable(19),M.dispersion&&o.enable(20),M.batchingColor&&o.enable(21),M.gradientMap&&o.enable(22),S.push(o.mask),o.disableAll(),M.fog&&o.enable(0),M.useFog&&o.enable(1),M.flatShading&&o.enable(2),M.logarithmicDepthBuffer&&o.enable(3),M.reversedDepthBuffer&&o.enable(4),M.skinning&&o.enable(5),M.morphTargets&&o.enable(6),M.morphNormals&&o.enable(7),M.morphColors&&o.enable(8),M.premultipliedAlpha&&o.enable(9),M.shadowMapEnabled&&o.enable(10),M.doubleSided&&o.enable(11),M.flipSided&&o.enable(12),M.useDepthPacking&&o.enable(13),M.dithering&&o.enable(14),M.transmission&&o.enable(15),M.sheen&&o.enable(16),M.opaque&&o.enable(17),M.pointsUvs&&o.enable(18),M.decodeVideoTexture&&o.enable(19),M.decodeVideoTextureEmissive&&o.enable(20),M.alphaToCoverage&&o.enable(21),S.push(o.mask)}function _(S){let M=g[S.type],I;if(M){let B=Cn[M];I=pu.clone(B.uniforms)}else I=S.uniforms;return I}function T(S,M){let I;for(let B=0,z=h.length;B<z;B++){let V=h[B];if(V.cacheKey===M){I=V,++I.usedTimes;break}}return I===void 0&&(I=new yb(s,M,S,r),h.push(I)),I}function w(S){if(--S.usedTimes===0){let M=h.indexOf(S);h[M]=h[h.length-1],h.pop(),S.destroy()}}function C(S){l.remove(S)}function D(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:_,acquireProgram:T,releaseProgram:w,releaseShaderCache:C,programs:h,dispose:D}}function Eb(){let s=new WeakMap;function e(a){return s.has(a)}function t(a){let o=s.get(a);return o===void 0&&(o={},s.set(a,o)),o}function n(a){s.delete(a)}function i(a,o,l){s.get(a)[o]=l}function r(){s=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:r}}function Tb(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function Ou(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function Bu(){let s=[],e=0,t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function a(u,d,f,g,b,m){let p=s[e];return p===void 0?(p={id:u.id,object:u,geometry:d,material:f,groupOrder:g,renderOrder:u.renderOrder,z:b,group:m},s[e]=p):(p.id=u.id,p.object=u,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=u.renderOrder,p.z=b,p.group=m),e++,p}function o(u,d,f,g,b,m){let p=a(u,d,f,g,b,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function l(u,d,f,g,b,m){let p=a(u,d,f,g,b,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function c(u,d){t.length>1&&t.sort(u||Tb),n.length>1&&n.sort(d||Ou),i.length>1&&i.sort(d||Ou)}function h(){for(let u=e,d=s.length;u<d;u++){let f=s[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:o,unshift:l,finish:h,sort:c}}function wb(){let s=new WeakMap;function e(n,i){let r=s.get(n),a;return r===void 0?(a=new Bu,s.set(n,[a])):i>=r.length?(a=new Bu,r.push(a)):a=r[i],a}function t(){s=new WeakMap}return{get:e,dispose:t}}function Ab(){let s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new R,color:new Ce};break;case"SpotLight":t={position:new R,direction:new R,color:new Ce,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new R,color:new Ce,distance:0,decay:0};break;case"HemisphereLight":t={direction:new R,skyColor:new Ce,groundColor:new Ce};break;case"RectAreaLight":t={color:new Ce,position:new R,halfWidth:new R,halfHeight:new R};break}return s[e.id]=t,t}}}function Rb(){let s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new xe,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}var Cb=0;function Pb(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function Ib(s){let e=new Ab,t=Rb(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new R);let i=new R,r=new ze,a=new ze;function o(c){let h=0,u=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let f=0,g=0,b=0,m=0,p=0,v=0,y=0,_=0,T=0,w=0,C=0;c.sort(Pb);for(let S=0,M=c.length;S<M;S++){let I=c[S],B=I.color,z=I.intensity,V=I.distance,j=I.shadow&&I.shadow.map?I.shadow.map.texture:null;if(I.isAmbientLight)h+=B.r*z,u+=B.g*z,d+=B.b*z;else if(I.isLightProbe){for(let N=0;N<9;N++)n.probe[N].addScaledVector(I.sh.coefficients[N],z);C++}else if(I.isDirectionalLight){let N=e.get(I);if(N.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){let W=I.shadow,F=t.get(I);F.shadowIntensity=W.intensity,F.shadowBias=W.bias,F.shadowNormalBias=W.normalBias,F.shadowRadius=W.radius,F.shadowMapSize=W.mapSize,n.directionalShadow[f]=F,n.directionalShadowMap[f]=j,n.directionalShadowMatrix[f]=I.shadow.matrix,v++}n.directional[f]=N,f++}else if(I.isSpotLight){let N=e.get(I);N.position.setFromMatrixPosition(I.matrixWorld),N.color.copy(B).multiplyScalar(z),N.distance=V,N.coneCos=Math.cos(I.angle),N.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),N.decay=I.decay,n.spot[b]=N;let W=I.shadow;if(I.map&&(n.spotLightMap[T]=I.map,T++,W.updateMatrices(I),I.castShadow&&w++),n.spotLightMatrix[b]=W.matrix,I.castShadow){let F=t.get(I);F.shadowIntensity=W.intensity,F.shadowBias=W.bias,F.shadowNormalBias=W.normalBias,F.shadowRadius=W.radius,F.shadowMapSize=W.mapSize,n.spotShadow[b]=F,n.spotShadowMap[b]=j,_++}b++}else if(I.isRectAreaLight){let N=e.get(I);N.color.copy(B).multiplyScalar(z),N.halfWidth.set(I.width*.5,0,0),N.halfHeight.set(0,I.height*.5,0),n.rectArea[m]=N,m++}else if(I.isPointLight){let N=e.get(I);if(N.color.copy(I.color).multiplyScalar(I.intensity),N.distance=I.distance,N.decay=I.decay,I.castShadow){let W=I.shadow,F=t.get(I);F.shadowIntensity=W.intensity,F.shadowBias=W.bias,F.shadowNormalBias=W.normalBias,F.shadowRadius=W.radius,F.shadowMapSize=W.mapSize,F.shadowCameraNear=W.camera.near,F.shadowCameraFar=W.camera.far,n.pointShadow[g]=F,n.pointShadowMap[g]=j,n.pointShadowMatrix[g]=I.shadow.matrix,y++}n.point[g]=N,g++}else if(I.isHemisphereLight){let N=e.get(I);N.skyColor.copy(I.color).multiplyScalar(z),N.groundColor.copy(I.groundColor).multiplyScalar(z),n.hemi[p]=N,p++}}m>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=he.LTC_FLOAT_1,n.rectAreaLTC2=he.LTC_FLOAT_2):(n.rectAreaLTC1=he.LTC_HALF_1,n.rectAreaLTC2=he.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;let D=n.hash;(D.directionalLength!==f||D.pointLength!==g||D.spotLength!==b||D.rectAreaLength!==m||D.hemiLength!==p||D.numDirectionalShadows!==v||D.numPointShadows!==y||D.numSpotShadows!==_||D.numSpotMaps!==T||D.numLightProbes!==C)&&(n.directional.length=f,n.spot.length=b,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=v,n.directionalShadowMap.length=v,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=_,n.spotShadowMap.length=_,n.directionalShadowMatrix.length=v,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=_+T-w,n.spotLightMap.length=T,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=C,D.directionalLength=f,D.pointLength=g,D.spotLength=b,D.rectAreaLength=m,D.hemiLength=p,D.numDirectionalShadows=v,D.numPointShadows=y,D.numSpotShadows=_,D.numSpotMaps=T,D.numLightProbes=C,n.version=Cb++)}function l(c,h){let u=0,d=0,f=0,g=0,b=0,m=h.matrixWorldInverse;for(let p=0,v=c.length;p<v;p++){let y=c[p];if(y.isDirectionalLight){let _=n.directional[u];_.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),_.direction.sub(i),_.direction.transformDirection(m),u++}else if(y.isSpotLight){let _=n.spot[f];_.position.setFromMatrixPosition(y.matrixWorld),_.position.applyMatrix4(m),_.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),_.direction.sub(i),_.direction.transformDirection(m),f++}else if(y.isRectAreaLight){let _=n.rectArea[g];_.position.setFromMatrixPosition(y.matrixWorld),_.position.applyMatrix4(m),a.identity(),r.copy(y.matrixWorld),r.premultiply(m),a.extractRotation(r),_.halfWidth.set(y.width*.5,0,0),_.halfHeight.set(0,y.height*.5,0),_.halfWidth.applyMatrix4(a),_.halfHeight.applyMatrix4(a),g++}else if(y.isPointLight){let _=n.point[d];_.position.setFromMatrixPosition(y.matrixWorld),_.position.applyMatrix4(m),d++}else if(y.isHemisphereLight){let _=n.hemi[b];_.direction.setFromMatrixPosition(y.matrixWorld),_.direction.transformDirection(m),b++}}}return{setup:o,setupView:l,state:n}}function ku(s){let e=new Ib(s),t=[],n=[];function i(h){c.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function l(h){e.setupView(t,h)}let c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:a}}function Db(s){let e=new WeakMap;function t(i,r=0){let a=e.get(i),o;return a===void 0?(o=new ku(s),e.set(i,[o])):r>=a.length?(o=new ku(s),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}var Lb=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Ub(s,e,t){let n=new hs,i=new xe,r=new xe,a=new Qe,o=new ma({depthPacking:nu}),l=new ga,c={},h=t.maxTextureSize,u={[fn]:Pt,[Pt]:fn,[It]:It},d=new gn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new xe},radius:{value:4}},vertexShader:Lb,fragmentShader:Nb}),f=d.clone();f.defines.HORIZONTAL_PASS=1;let g=new ft;g.setAttribute("position",new bt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new qe(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=_c;let p=this.type;this.render=function(w,C,D){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;let S=s.getRenderTarget(),M=s.getActiveCubeFace(),I=s.getActiveMipmapLevel(),B=s.state;B.setBlending(Xn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let z=p!==Rn&&this.type===Rn,V=p===Rn&&this.type!==Rn;for(let j=0,N=w.length;j<N;j++){let W=w[j],F=W.shadow;if(F===void 0){console.warn("THREE.WebGLShadowMap:",W,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;i.copy(F.mapSize);let Z=F.getFrameExtents();if(i.multiply(Z),r.copy(F.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/Z.x),i.x=r.x*Z.x,F.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/Z.y),i.y=r.y*Z.y,F.mapSize.y=r.y)),F.map===null||z===!0||V===!0){let ce=this.type!==Rn?{minFilter:Rt,magFilter:Rt}:{};F.map!==null&&F.map.dispose(),F.map=new Sn(i.x,i.y,ce),F.map.texture.name=W.name+".shadowMap",F.camera.updateProjectionMatrix()}s.setRenderTarget(F.map),s.clear();let K=F.getViewportCount();for(let ce=0;ce<K;ce++){let J=F.getViewport(ce);a.set(r.x*J.x,r.y*J.y,r.x*J.z,r.y*J.w),B.viewport(a),F.updateMatrices(W,ce),n=F.getFrustum(),_(C,D,F.camera,W,this.type)}F.isPointLightShadow!==!0&&this.type===Rn&&v(F,D),F.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(S,M,I)};function v(w,C){let D=e.update(b);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Sn(i.x,i.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,s.setRenderTarget(w.mapPass),s.clear(),s.renderBufferDirect(C,null,D,d,b,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,s.setRenderTarget(w.map),s.clear(),s.renderBufferDirect(C,null,D,f,b,null)}function y(w,C,D,S){let M=null,I=D.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(I!==void 0)M=I;else if(M=D.isPointLight===!0?l:o,s.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let B=M.uuid,z=C.uuid,V=c[B];V===void 0&&(V={},c[B]=V);let j=V[z];j===void 0&&(j=M.clone(),V[z]=j,C.addEventListener("dispose",T)),M=j}if(M.visible=C.visible,M.wireframe=C.wireframe,S===Rn?M.side=C.shadowSide!==null?C.shadowSide:C.side:M.side=C.shadowSide!==null?C.shadowSide:u[C.side],M.alphaMap=C.alphaMap,M.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,M.map=C.map,M.clipShadows=C.clipShadows,M.clippingPlanes=C.clippingPlanes,M.clipIntersection=C.clipIntersection,M.displacementMap=C.displacementMap,M.displacementScale=C.displacementScale,M.displacementBias=C.displacementBias,M.wireframeLinewidth=C.wireframeLinewidth,M.linewidth=C.linewidth,D.isPointLight===!0&&M.isMeshDistanceMaterial===!0){let B=s.properties.get(M);B.light=D}return M}function _(w,C,D,S,M){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===Rn)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,w.matrixWorld);let z=e.update(w),V=w.material;if(Array.isArray(V)){let j=z.groups;for(let N=0,W=j.length;N<W;N++){let F=j[N],Z=V[F.materialIndex];if(Z&&Z.visible){let K=y(w,Z,S,M);w.onBeforeShadow(s,w,C,D,z,K,F),s.renderBufferDirect(D,null,z,K,w,F),w.onAfterShadow(s,w,C,D,z,K,F)}}}else if(V.visible){let j=y(w,V,S,M);w.onBeforeShadow(s,w,C,D,z,j,null),s.renderBufferDirect(D,null,z,j,w,null),w.onAfterShadow(s,w,C,D,z,j,null)}}let B=w.children;for(let z=0,V=B.length;z<V;z++)_(B[z],C,D,S,M)}function T(w){w.target.removeEventListener("dispose",T);for(let D in c){let S=c[D],M=w.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}var Fb={[Ta]:wa,[Aa]:Pa,[Ra]:Ia,[bi]:Ca,[wa]:Ta,[Pa]:Aa,[Ia]:Ra,[Ca]:bi};function Ob(s,e){function t(){let L=!1,re=new Qe,oe=null,_e=new Qe(0,0,0,0);return{setMask:function(te){oe!==te&&!L&&(s.colorMask(te,te,te,te),oe=te)},setLocked:function(te){L=te},setClear:function(te,Q,ye,ke,ot){ot===!0&&(te*=ke,Q*=ke,ye*=ke),re.set(te,Q,ye,ke),_e.equals(re)===!1&&(s.clearColor(te,Q,ye,ke),_e.copy(re))},reset:function(){L=!1,oe=null,_e.set(-1,0,0,0)}}}function n(){let L=!1,re=!1,oe=null,_e=null,te=null;return{setReversed:function(Q){if(re!==Q){let ye=e.get("EXT_clip_control");Q?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),re=Q;let ke=te;te=null,this.setClear(ke)}},getReversed:function(){return re},setTest:function(Q){Q?$(s.DEPTH_TEST):le(s.DEPTH_TEST)},setMask:function(Q){oe!==Q&&!L&&(s.depthMask(Q),oe=Q)},setFunc:function(Q){if(re&&(Q=Fb[Q]),_e!==Q){switch(Q){case Ta:s.depthFunc(s.NEVER);break;case wa:s.depthFunc(s.ALWAYS);break;case Aa:s.depthFunc(s.LESS);break;case bi:s.depthFunc(s.LEQUAL);break;case Ra:s.depthFunc(s.EQUAL);break;case Ca:s.depthFunc(s.GEQUAL);break;case Pa:s.depthFunc(s.GREATER);break;case Ia:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}_e=Q}},setLocked:function(Q){L=Q},setClear:function(Q){te!==Q&&(re&&(Q=1-Q),s.clearDepth(Q),te=Q)},reset:function(){L=!1,oe=null,_e=null,te=null,re=!1}}}function i(){let L=!1,re=null,oe=null,_e=null,te=null,Q=null,ye=null,ke=null,ot=null;return{setTest:function(tt){L||(tt?$(s.STENCIL_TEST):le(s.STENCIL_TEST))},setMask:function(tt){re!==tt&&!L&&(s.stencilMask(tt),re=tt)},setFunc:function(tt,In,xn){(oe!==tt||_e!==In||te!==xn)&&(s.stencilFunc(tt,In,xn),oe=tt,_e=In,te=xn)},setOp:function(tt,In,xn){(Q!==tt||ye!==In||ke!==xn)&&(s.stencilOp(tt,In,xn),Q=tt,ye=In,ke=xn)},setLocked:function(tt){L=tt},setClear:function(tt){ot!==tt&&(s.clearStencil(tt),ot=tt)},reset:function(){L=!1,re=null,oe=null,_e=null,te=null,Q=null,ye=null,ke=null,ot=null}}}let r=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap,h={},u={},d=new WeakMap,f=[],g=null,b=!1,m=null,p=null,v=null,y=null,_=null,T=null,w=null,C=new Ce(0,0,0),D=0,S=!1,M=null,I=null,B=null,z=null,V=null,j=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),N=!1,W=0,F=s.getParameter(s.VERSION);F.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(F)[1]),N=W>=1):F.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(F)[1]),N=W>=2);let Z=null,K={},ce=s.getParameter(s.SCISSOR_BOX),J=s.getParameter(s.VIEWPORT),ne=new Qe().fromArray(ce),Fe=new Qe().fromArray(J);function be(L,re,oe,_e){let te=new Uint8Array(4),Q=s.createTexture();s.bindTexture(L,Q),s.texParameteri(L,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(L,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let ye=0;ye<oe;ye++)L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY?s.texImage3D(re,0,s.RGBA,1,1,_e,0,s.RGBA,s.UNSIGNED_BYTE,te):s.texImage2D(re+ye,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,te);return Q}let q={};q[s.TEXTURE_2D]=be(s.TEXTURE_2D,s.TEXTURE_2D,1),q[s.TEXTURE_CUBE_MAP]=be(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[s.TEXTURE_2D_ARRAY]=be(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),q[s.TEXTURE_3D]=be(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),$(s.DEPTH_TEST),a.setFunc(bi),Ae(!1),ge(bc),$(s.CULL_FACE),Ye(Xn);function $(L){h[L]!==!0&&(s.enable(L),h[L]=!0)}function le(L){h[L]!==!1&&(s.disable(L),h[L]=!1)}function Re(L,re){return u[L]!==re?(s.bindFramebuffer(L,re),u[L]=re,L===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=re),L===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=re),!0):!1}function pe(L,re){let oe=f,_e=!1;if(L){oe=d.get(re),oe===void 0&&(oe=[],d.set(re,oe));let te=L.textures;if(oe.length!==te.length||oe[0]!==s.COLOR_ATTACHMENT0){for(let Q=0,ye=te.length;Q<ye;Q++)oe[Q]=s.COLOR_ATTACHMENT0+Q;oe.length=te.length,_e=!0}}else oe[0]!==s.BACK&&(oe[0]=s.BACK,_e=!0);_e&&s.drawBuffers(oe)}function Oe(L){return g!==L?(s.useProgram(L),g=L,!0):!1}let et={[ni]:s.FUNC_ADD,[Rh]:s.FUNC_SUBTRACT,[Ch]:s.FUNC_REVERSE_SUBTRACT};et[Ph]=s.MIN,et[Ih]=s.MAX;let P={[Dh]:s.ZERO,[Lh]:s.ONE,[Nh]:s.SRC_COLOR,[$r]:s.SRC_ALPHA,[zh]:s.SRC_ALPHA_SATURATE,[Bh]:s.DST_COLOR,[Fh]:s.DST_ALPHA,[Uh]:s.ONE_MINUS_SRC_COLOR,[Qr]:s.ONE_MINUS_SRC_ALPHA,[kh]:s.ONE_MINUS_DST_COLOR,[Oh]:s.ONE_MINUS_DST_ALPHA,[Hh]:s.CONSTANT_COLOR,[Gh]:s.ONE_MINUS_CONSTANT_COLOR,[Vh]:s.CONSTANT_ALPHA,[Wh]:s.ONE_MINUS_CONSTANT_ALPHA};function Ye(L,re,oe,_e,te,Q,ye,ke,ot,tt){if(L===Xn){b===!0&&(le(s.BLEND),b=!1);return}if(b===!1&&($(s.BLEND),b=!0),L!==Ah){if(L!==m||tt!==S){if((p!==ni||_!==ni)&&(s.blendEquation(s.FUNC_ADD),p=ni,_=ni),tt)switch(L){case gi:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case xc:s.blendFunc(s.ONE,s.ONE);break;case vc:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case yc:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case gi:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case xc:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case vc:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case yc:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}v=null,y=null,T=null,w=null,C.set(0,0,0),D=0,m=L,S=tt}return}te=te||re,Q=Q||oe,ye=ye||_e,(re!==p||te!==_)&&(s.blendEquationSeparate(et[re],et[te]),p=re,_=te),(oe!==v||_e!==y||Q!==T||ye!==w)&&(s.blendFuncSeparate(P[oe],P[_e],P[Q],P[ye]),v=oe,y=_e,T=Q,w=ye),(ke.equals(C)===!1||ot!==D)&&(s.blendColor(ke.r,ke.g,ke.b,ot),C.copy(ke),D=ot),m=L,S=!1}function De(L,re){L.side===It?le(s.CULL_FACE):$(s.CULL_FACE);let oe=L.side===Pt;re&&(oe=!oe),Ae(oe),L.blending===gi&&L.transparent===!1?Ye(Xn):Ye(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),r.setMask(L.colorWrite);let _e=L.stencilWrite;o.setTest(_e),_e&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Me(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?$(s.SAMPLE_ALPHA_TO_COVERAGE):le(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(L){M!==L&&(L?s.frontFace(s.CW):s.frontFace(s.CCW),M=L)}function ge(L){L!==Th?($(s.CULL_FACE),L!==I&&(L===bc?s.cullFace(s.BACK):L===wh?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):le(s.CULL_FACE),I=L}function Ze(L){L!==B&&(N&&s.lineWidth(L),B=L)}function Me(L,re,oe){L?($(s.POLYGON_OFFSET_FILL),(z!==re||V!==oe)&&(s.polygonOffset(re,oe),z=re,V=oe)):le(s.POLYGON_OFFSET_FILL)}function Ve(L){L?$(s.SCISSOR_TEST):le(s.SCISSOR_TEST)}function Tt(L){L===void 0&&(L=s.TEXTURE0+j-1),Z!==L&&(s.activeTexture(L),Z=L)}function gt(L,re,oe){oe===void 0&&(Z===null?oe=s.TEXTURE0+j-1:oe=Z);let _e=K[oe];_e===void 0&&(_e={type:void 0,texture:void 0},K[oe]=_e),(_e.type!==L||_e.texture!==re)&&(Z!==oe&&(s.activeTexture(oe),Z=oe),s.bindTexture(L,re||q[L]),_e.type=L,_e.texture=re)}function A(){let L=K[Z];L!==void 0&&L.type!==void 0&&(s.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function x(){try{s.compressedTexImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function k(){try{s.compressedTexImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Y(){try{s.texSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ee(){try{s.texSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function X(){try{s.compressedTexSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function we(){try{s.compressedTexSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ae(){try{s.texStorage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Se(){try{s.texStorage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ee(){try{s.texImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function se(){try{s.texImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function fe(L){ne.equals(L)===!1&&(s.scissor(L.x,L.y,L.z,L.w),ne.copy(L))}function Ne(L){Fe.equals(L)===!1&&(s.viewport(L.x,L.y,L.z,L.w),Fe.copy(L))}function Te(L,re){let oe=c.get(re);oe===void 0&&(oe=new WeakMap,c.set(re,oe));let _e=oe.get(L);_e===void 0&&(_e=s.getUniformBlockIndex(re,L.name),oe.set(L,_e))}function ue(L,re){let _e=c.get(re).get(L);l.get(re)!==_e&&(s.uniformBlockBinding(re,_e,L.__bindingPointIndex),l.set(re,_e))}function Ge(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},Z=null,K={},u={},d=new WeakMap,f=[],g=null,b=!1,m=null,p=null,v=null,y=null,_=null,T=null,w=null,C=new Ce(0,0,0),D=0,S=!1,M=null,I=null,B=null,z=null,V=null,ne.set(0,0,s.canvas.width,s.canvas.height),Fe.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:$,disable:le,bindFramebuffer:Re,drawBuffers:pe,useProgram:Oe,setBlending:Ye,setMaterial:De,setFlipSided:Ae,setCullFace:ge,setLineWidth:Ze,setPolygonOffset:Me,setScissorTest:Ve,activeTexture:Tt,bindTexture:gt,unbindTexture:A,compressedTexImage2D:x,compressedTexImage3D:k,texImage2D:Ee,texImage3D:se,updateUBOMapping:Te,uniformBlockBinding:ue,texStorage2D:ae,texStorage3D:Se,texSubImage2D:Y,texSubImage3D:ee,compressedTexSubImage2D:X,compressedTexSubImage3D:we,scissor:fe,viewport:Ne,reset:Ge}}function Bb(s,e,t,n,i,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new xe,h=new WeakMap,u,d=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,x){return f?new OffscreenCanvas(A,x):ns("canvas")}function b(A,x,k){let Y=1,ee=gt(A);if((ee.width>k||ee.height>k)&&(Y=k/Math.max(ee.width,ee.height)),Y<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){let X=Math.floor(Y*ee.width),we=Math.floor(Y*ee.height);u===void 0&&(u=g(X,we));let ae=x?g(X,we):u;return ae.width=X,ae.height=we,ae.getContext("2d").drawImage(A,0,0,X,we),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+X+"x"+we+")."),ae}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),A;return A}function m(A){return A.generateMipmaps}function p(A){s.generateMipmap(A)}function v(A){return A.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?s.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function y(A,x,k,Y,ee=!1){if(A!==null){if(s[A]!==void 0)return s[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let X=x;if(x===s.RED&&(k===s.FLOAT&&(X=s.R32F),k===s.HALF_FLOAT&&(X=s.R16F),k===s.UNSIGNED_BYTE&&(X=s.R8)),x===s.RED_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.R8UI),k===s.UNSIGNED_SHORT&&(X=s.R16UI),k===s.UNSIGNED_INT&&(X=s.R32UI),k===s.BYTE&&(X=s.R8I),k===s.SHORT&&(X=s.R16I),k===s.INT&&(X=s.R32I)),x===s.RG&&(k===s.FLOAT&&(X=s.RG32F),k===s.HALF_FLOAT&&(X=s.RG16F),k===s.UNSIGNED_BYTE&&(X=s.RG8)),x===s.RG_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.RG8UI),k===s.UNSIGNED_SHORT&&(X=s.RG16UI),k===s.UNSIGNED_INT&&(X=s.RG32UI),k===s.BYTE&&(X=s.RG8I),k===s.SHORT&&(X=s.RG16I),k===s.INT&&(X=s.RG32I)),x===s.RGB_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.RGB8UI),k===s.UNSIGNED_SHORT&&(X=s.RGB16UI),k===s.UNSIGNED_INT&&(X=s.RGB32UI),k===s.BYTE&&(X=s.RGB8I),k===s.SHORT&&(X=s.RGB16I),k===s.INT&&(X=s.RGB32I)),x===s.RGBA_INTEGER&&(k===s.UNSIGNED_BYTE&&(X=s.RGBA8UI),k===s.UNSIGNED_SHORT&&(X=s.RGBA16UI),k===s.UNSIGNED_INT&&(X=s.RGBA32UI),k===s.BYTE&&(X=s.RGBA8I),k===s.SHORT&&(X=s.RGBA16I),k===s.INT&&(X=s.RGBA32I)),x===s.RGB&&(k===s.UNSIGNED_INT_5_9_9_9_REV&&(X=s.RGB9_E5),k===s.UNSIGNED_INT_10F_11F_11F_REV&&(X=s.R11F_G11F_B10F)),x===s.RGBA){let we=ee?Hs:Ke.getTransfer(Y);k===s.FLOAT&&(X=s.RGBA32F),k===s.HALF_FLOAT&&(X=s.RGBA16F),k===s.UNSIGNED_BYTE&&(X=we===it?s.SRGB8_ALPHA8:s.RGBA8),k===s.UNSIGNED_SHORT_4_4_4_4&&(X=s.RGBA4),k===s.UNSIGNED_SHORT_5_5_5_1&&(X=s.RGB5_A1)}return(X===s.R16F||X===s.R32F||X===s.RG16F||X===s.RG32F||X===s.RGBA16F||X===s.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function _(A,x){let k;return A?x===null||x===oi||x===xs?k=s.DEPTH24_STENCIL8:x===nn?k=s.DEPTH32F_STENCIL8:x===bs&&(k=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===oi||x===xs?k=s.DEPTH_COMPONENT24:x===nn?k=s.DEPTH_COMPONENT32F:x===bs&&(k=s.DEPTH_COMPONENT16),k}function T(A,x){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Rt&&A.minFilter!==kt?Math.log2(Math.max(x.width,x.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?x.mipmaps.length:1}function w(A){let x=A.target;x.removeEventListener("dispose",w),D(x),x.isVideoTexture&&h.delete(x)}function C(A){let x=A.target;x.removeEventListener("dispose",C),M(x)}function D(A){let x=n.get(A);if(x.__webglInit===void 0)return;let k=A.source,Y=d.get(k);if(Y){let ee=Y[x.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&S(A),Object.keys(Y).length===0&&d.delete(k)}n.remove(A)}function S(A){let x=n.get(A);s.deleteTexture(x.__webglTexture);let k=A.source,Y=d.get(k);delete Y[x.__cacheKey],a.memory.textures--}function M(A){let x=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(x.__webglFramebuffer[Y]))for(let ee=0;ee<x.__webglFramebuffer[Y].length;ee++)s.deleteFramebuffer(x.__webglFramebuffer[Y][ee]);else s.deleteFramebuffer(x.__webglFramebuffer[Y]);x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer[Y])}else{if(Array.isArray(x.__webglFramebuffer))for(let Y=0;Y<x.__webglFramebuffer.length;Y++)s.deleteFramebuffer(x.__webglFramebuffer[Y]);else s.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&s.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Y=0;Y<x.__webglColorRenderbuffer.length;Y++)x.__webglColorRenderbuffer[Y]&&s.deleteRenderbuffer(x.__webglColorRenderbuffer[Y]);x.__webglDepthRenderbuffer&&s.deleteRenderbuffer(x.__webglDepthRenderbuffer)}let k=A.textures;for(let Y=0,ee=k.length;Y<ee;Y++){let X=n.get(k[Y]);X.__webglTexture&&(s.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(k[Y])}n.remove(A)}let I=0;function B(){I=0}function z(){let A=I;return A>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),I+=1,A}function V(A){let x=[];return x.push(A.wrapS),x.push(A.wrapT),x.push(A.wrapR||0),x.push(A.magFilter),x.push(A.minFilter),x.push(A.anisotropy),x.push(A.internalFormat),x.push(A.format),x.push(A.type),x.push(A.generateMipmaps),x.push(A.premultiplyAlpha),x.push(A.flipY),x.push(A.unpackAlignment),x.push(A.colorSpace),x.join()}function j(A,x){let k=n.get(A);if(A.isVideoTexture&&Ve(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&k.__version!==A.version){let Y=A.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{q(k,A,x);return}}else A.isExternalTexture&&(k.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,k.__webglTexture,s.TEXTURE0+x)}function N(A,x){let k=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&k.__version!==A.version){q(k,A,x);return}t.bindTexture(s.TEXTURE_2D_ARRAY,k.__webglTexture,s.TEXTURE0+x)}function W(A,x){let k=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&k.__version!==A.version){q(k,A,x);return}t.bindTexture(s.TEXTURE_3D,k.__webglTexture,s.TEXTURE0+x)}function F(A,x){let k=n.get(A);if(A.version>0&&k.__version!==A.version){$(k,A,x);return}t.bindTexture(s.TEXTURE_CUBE_MAP,k.__webglTexture,s.TEXTURE0+x)}let Z={[$t]:s.REPEAT,[yn]:s.CLAMP_TO_EDGE,[es]:s.MIRRORED_REPEAT},K={[Rt]:s.NEAREST,[Ua]:s.NEAREST_MIPMAP_NEAREST,[Ii]:s.NEAREST_MIPMAP_LINEAR,[kt]:s.LINEAR,[gs]:s.LINEAR_MIPMAP_NEAREST,[bn]:s.LINEAR_MIPMAP_LINEAR},ce={[su]:s.NEVER,[hu]:s.ALWAYS,[ru]:s.LESS,[Lc]:s.LEQUAL,[au]:s.EQUAL,[lu]:s.GEQUAL,[ou]:s.GREATER,[cu]:s.NOTEQUAL};function J(A,x){if(x.type===nn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===kt||x.magFilter===gs||x.magFilter===Ii||x.magFilter===bn||x.minFilter===kt||x.minFilter===gs||x.minFilter===Ii||x.minFilter===bn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(A,s.TEXTURE_WRAP_S,Z[x.wrapS]),s.texParameteri(A,s.TEXTURE_WRAP_T,Z[x.wrapT]),(A===s.TEXTURE_3D||A===s.TEXTURE_2D_ARRAY)&&s.texParameteri(A,s.TEXTURE_WRAP_R,Z[x.wrapR]),s.texParameteri(A,s.TEXTURE_MAG_FILTER,K[x.magFilter]),s.texParameteri(A,s.TEXTURE_MIN_FILTER,K[x.minFilter]),x.compareFunction&&(s.texParameteri(A,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(A,s.TEXTURE_COMPARE_FUNC,ce[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Rt||x.minFilter!==Ii&&x.minFilter!==bn||x.type===nn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){let k=e.get("EXT_texture_filter_anisotropic");s.texParameterf(A,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,i.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function ne(A,x){let k=!1;A.__webglInit===void 0&&(A.__webglInit=!0,x.addEventListener("dispose",w));let Y=x.source,ee=d.get(Y);ee===void 0&&(ee={},d.set(Y,ee));let X=V(x);if(X!==A.__cacheKey){ee[X]===void 0&&(ee[X]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,k=!0),ee[X].usedTimes++;let we=ee[A.__cacheKey];we!==void 0&&(ee[A.__cacheKey].usedTimes--,we.usedTimes===0&&S(x)),A.__cacheKey=X,A.__webglTexture=ee[X].texture}return k}function Fe(A,x,k){return Math.floor(Math.floor(A/k)/x)}function be(A,x,k,Y){let X=A.updateRanges;if(X.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,x.width,x.height,k,Y,x.data);else{X.sort((se,fe)=>se.start-fe.start);let we=0;for(let se=1;se<X.length;se++){let fe=X[we],Ne=X[se],Te=fe.start+fe.count,ue=Fe(Ne.start,x.width,4),Ge=Fe(fe.start,x.width,4);Ne.start<=Te+1&&ue===Ge&&Fe(Ne.start+Ne.count-1,x.width,4)===ue?fe.count=Math.max(fe.count,Ne.start+Ne.count-fe.start):(++we,X[we]=Ne)}X.length=we+1;let ae=s.getParameter(s.UNPACK_ROW_LENGTH),Se=s.getParameter(s.UNPACK_SKIP_PIXELS),Ee=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,x.width);for(let se=0,fe=X.length;se<fe;se++){let Ne=X[se],Te=Math.floor(Ne.start/4),ue=Math.ceil(Ne.count/4),Ge=Te%x.width,L=Math.floor(Te/x.width),re=ue,oe=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,Ge),s.pixelStorei(s.UNPACK_SKIP_ROWS,L),t.texSubImage2D(s.TEXTURE_2D,0,Ge,L,re,oe,k,Y,x.data)}A.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,ae),s.pixelStorei(s.UNPACK_SKIP_PIXELS,Se),s.pixelStorei(s.UNPACK_SKIP_ROWS,Ee)}}function q(A,x,k){let Y=s.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Y=s.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Y=s.TEXTURE_3D);let ee=ne(A,x),X=x.source;t.bindTexture(Y,A.__webglTexture,s.TEXTURE0+k);let we=n.get(X);if(X.version!==we.__version||ee===!0){t.activeTexture(s.TEXTURE0+k);let ae=Ke.getPrimaries(Ke.workingColorSpace),Se=x.colorSpace===Kn?null:Ke.getPrimaries(x.colorSpace),Ee=x.colorSpace===Kn||ae===Se?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);let se=b(x.image,!1,i.maxTextureSize);se=Tt(x,se);let fe=r.convert(x.format,x.colorSpace),Ne=r.convert(x.type),Te=y(x.internalFormat,fe,Ne,x.colorSpace,x.isVideoTexture);J(Y,x);let ue,Ge=x.mipmaps,L=x.isVideoTexture!==!0,re=we.__version===void 0||ee===!0,oe=X.dataReady,_e=T(x,se);if(x.isDepthTexture)Te=_(x.format===vs,x.type),re&&(L?t.texStorage2D(s.TEXTURE_2D,1,Te,se.width,se.height):t.texImage2D(s.TEXTURE_2D,0,Te,se.width,se.height,0,fe,Ne,null));else if(x.isDataTexture)if(Ge.length>0){L&&re&&t.texStorage2D(s.TEXTURE_2D,_e,Te,Ge[0].width,Ge[0].height);for(let te=0,Q=Ge.length;te<Q;te++)ue=Ge[te],L?oe&&t.texSubImage2D(s.TEXTURE_2D,te,0,0,ue.width,ue.height,fe,Ne,ue.data):t.texImage2D(s.TEXTURE_2D,te,Te,ue.width,ue.height,0,fe,Ne,ue.data);x.generateMipmaps=!1}else L?(re&&t.texStorage2D(s.TEXTURE_2D,_e,Te,se.width,se.height),oe&&be(x,se,fe,Ne)):t.texImage2D(s.TEXTURE_2D,0,Te,se.width,se.height,0,fe,Ne,se.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){L&&re&&t.texStorage3D(s.TEXTURE_2D_ARRAY,_e,Te,Ge[0].width,Ge[0].height,se.depth);for(let te=0,Q=Ge.length;te<Q;te++)if(ue=Ge[te],x.format!==Kt)if(fe!==null)if(L){if(oe)if(x.layerUpdates.size>0){let ye=Hc(ue.width,ue.height,x.format,x.type);for(let ke of x.layerUpdates){let ot=ue.data.subarray(ke*ye/ue.data.BYTES_PER_ELEMENT,(ke+1)*ye/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,te,0,0,ke,ue.width,ue.height,1,fe,ot)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,te,0,0,0,ue.width,ue.height,se.depth,fe,ue.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,te,Te,ue.width,ue.height,se.depth,0,ue.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?oe&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,te,0,0,0,ue.width,ue.height,se.depth,fe,Ne,ue.data):t.texImage3D(s.TEXTURE_2D_ARRAY,te,Te,ue.width,ue.height,se.depth,0,fe,Ne,ue.data)}else{L&&re&&t.texStorage2D(s.TEXTURE_2D,_e,Te,Ge[0].width,Ge[0].height);for(let te=0,Q=Ge.length;te<Q;te++)ue=Ge[te],x.format!==Kt?fe!==null?L?oe&&t.compressedTexSubImage2D(s.TEXTURE_2D,te,0,0,ue.width,ue.height,fe,ue.data):t.compressedTexImage2D(s.TEXTURE_2D,te,Te,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?oe&&t.texSubImage2D(s.TEXTURE_2D,te,0,0,ue.width,ue.height,fe,Ne,ue.data):t.texImage2D(s.TEXTURE_2D,te,Te,ue.width,ue.height,0,fe,Ne,ue.data)}else if(x.isDataArrayTexture)if(L){if(re&&t.texStorage3D(s.TEXTURE_2D_ARRAY,_e,Te,se.width,se.height,se.depth),oe)if(x.layerUpdates.size>0){let te=Hc(se.width,se.height,x.format,x.type);for(let Q of x.layerUpdates){let ye=se.data.subarray(Q*te/se.data.BYTES_PER_ELEMENT,(Q+1)*te/se.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Q,se.width,se.height,1,fe,Ne,ye)}x.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,fe,Ne,se.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,Te,se.width,se.height,se.depth,0,fe,Ne,se.data);else if(x.isData3DTexture)L?(re&&t.texStorage3D(s.TEXTURE_3D,_e,Te,se.width,se.height,se.depth),oe&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,fe,Ne,se.data)):t.texImage3D(s.TEXTURE_3D,0,Te,se.width,se.height,se.depth,0,fe,Ne,se.data);else if(x.isFramebufferTexture){if(re)if(L)t.texStorage2D(s.TEXTURE_2D,_e,Te,se.width,se.height);else{let te=se.width,Q=se.height;for(let ye=0;ye<_e;ye++)t.texImage2D(s.TEXTURE_2D,ye,Te,te,Q,0,fe,Ne,null),te>>=1,Q>>=1}}else if(Ge.length>0){if(L&&re){let te=gt(Ge[0]);t.texStorage2D(s.TEXTURE_2D,_e,Te,te.width,te.height)}for(let te=0,Q=Ge.length;te<Q;te++)ue=Ge[te],L?oe&&t.texSubImage2D(s.TEXTURE_2D,te,0,0,fe,Ne,ue):t.texImage2D(s.TEXTURE_2D,te,Te,fe,Ne,ue);x.generateMipmaps=!1}else if(L){if(re){let te=gt(se);t.texStorage2D(s.TEXTURE_2D,_e,Te,te.width,te.height)}oe&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,fe,Ne,se)}else t.texImage2D(s.TEXTURE_2D,0,Te,fe,Ne,se);m(x)&&p(Y),we.__version=X.version,x.onUpdate&&x.onUpdate(x)}A.__version=x.version}function $(A,x,k){if(x.image.length!==6)return;let Y=ne(A,x),ee=x.source;t.bindTexture(s.TEXTURE_CUBE_MAP,A.__webglTexture,s.TEXTURE0+k);let X=n.get(ee);if(ee.version!==X.__version||Y===!0){t.activeTexture(s.TEXTURE0+k);let we=Ke.getPrimaries(Ke.workingColorSpace),ae=x.colorSpace===Kn?null:Ke.getPrimaries(x.colorSpace),Se=x.colorSpace===Kn||we===ae?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);let Ee=x.isCompressedTexture||x.image[0].isCompressedTexture,se=x.image[0]&&x.image[0].isDataTexture,fe=[];for(let Q=0;Q<6;Q++)!Ee&&!se?fe[Q]=b(x.image[Q],!0,i.maxCubemapSize):fe[Q]=se?x.image[Q].image:x.image[Q],fe[Q]=Tt(x,fe[Q]);let Ne=fe[0],Te=r.convert(x.format,x.colorSpace),ue=r.convert(x.type),Ge=y(x.internalFormat,Te,ue,x.colorSpace),L=x.isVideoTexture!==!0,re=X.__version===void 0||Y===!0,oe=ee.dataReady,_e=T(x,Ne);J(s.TEXTURE_CUBE_MAP,x);let te;if(Ee){L&&re&&t.texStorage2D(s.TEXTURE_CUBE_MAP,_e,Ge,Ne.width,Ne.height);for(let Q=0;Q<6;Q++){te=fe[Q].mipmaps;for(let ye=0;ye<te.length;ye++){let ke=te[ye];x.format!==Kt?Te!==null?L?oe&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,0,0,ke.width,ke.height,Te,ke.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,Ge,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,0,0,ke.width,ke.height,Te,ue,ke.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,Ge,ke.width,ke.height,0,Te,ue,ke.data)}}}else{if(te=x.mipmaps,L&&re){te.length>0&&_e++;let Q=gt(fe[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,_e,Ge,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(se){L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,fe[Q].width,fe[Q].height,Te,ue,fe[Q].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,fe[Q].width,fe[Q].height,0,Te,ue,fe[Q].data);for(let ye=0;ye<te.length;ye++){let ot=te[ye].image[Q].image;L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,0,0,ot.width,ot.height,Te,ue,ot.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,Ge,ot.width,ot.height,0,Te,ue,ot.data)}}else{L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Te,ue,fe[Q]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,Te,ue,fe[Q]);for(let ye=0;ye<te.length;ye++){let ke=te[ye];L?oe&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,0,0,Te,ue,ke.image[Q]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,Ge,Te,ue,ke.image[Q])}}}m(x)&&p(s.TEXTURE_CUBE_MAP),X.__version=ee.version,x.onUpdate&&x.onUpdate(x)}A.__version=x.version}function le(A,x,k,Y,ee,X){let we=r.convert(k.format,k.colorSpace),ae=r.convert(k.type),Se=y(k.internalFormat,we,ae,k.colorSpace),Ee=n.get(x),se=n.get(k);if(se.__renderTarget=x,!Ee.__hasExternalTextures){let fe=Math.max(1,x.width>>X),Ne=Math.max(1,x.height>>X);ee===s.TEXTURE_3D||ee===s.TEXTURE_2D_ARRAY?t.texImage3D(ee,X,Se,fe,Ne,x.depth,0,we,ae,null):t.texImage2D(ee,X,Se,fe,Ne,0,we,ae,null)}t.bindFramebuffer(s.FRAMEBUFFER,A),Me(x)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Y,ee,se.__webglTexture,0,Ze(x)):(ee===s.TEXTURE_2D||ee>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,Y,ee,se.__webglTexture,X),t.bindFramebuffer(s.FRAMEBUFFER,null)}function Re(A,x,k){if(s.bindRenderbuffer(s.RENDERBUFFER,A),x.depthBuffer){let Y=x.depthTexture,ee=Y&&Y.isDepthTexture?Y.type:null,X=_(x.stencilBuffer,ee),we=x.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ae=Ze(x);Me(x)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ae,X,x.width,x.height):k?s.renderbufferStorageMultisample(s.RENDERBUFFER,ae,X,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,X,x.width,x.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,we,s.RENDERBUFFER,A)}else{let Y=x.textures;for(let ee=0;ee<Y.length;ee++){let X=Y[ee],we=r.convert(X.format,X.colorSpace),ae=r.convert(X.type),Se=y(X.internalFormat,we,ae,X.colorSpace),Ee=Ze(x);k&&Me(x)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ee,Se,x.width,x.height):Me(x)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ee,Se,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,Se,x.width,x.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function pe(A,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,A),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let Y=n.get(x.depthTexture);Y.__renderTarget=x,(!Y.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),j(x.depthTexture,0);let ee=Y.__webglTexture,X=Ze(x);if(x.depthTexture.format===ts)Me(x)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ee,0,X):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ee,0);else if(x.depthTexture.format===vs)Me(x)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ee,0,X):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function Oe(A){let x=n.get(A),k=A.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==A.depthTexture){let Y=A.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Y){let ee=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Y.removeEventListener("dispose",ee)};Y.addEventListener("dispose",ee),x.__depthDisposeCallback=ee}x.__boundDepthTexture=Y}if(A.depthTexture&&!x.__autoAllocateDepthBuffer){if(k)throw new Error("target.depthTexture not supported in Cube render targets");let Y=A.texture.mipmaps;Y&&Y.length>0?pe(x.__webglFramebuffer[0],A):pe(x.__webglFramebuffer,A)}else if(k){x.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer[Y]),x.__webglDepthbuffer[Y]===void 0)x.__webglDepthbuffer[Y]=s.createRenderbuffer(),Re(x.__webglDepthbuffer[Y],A,!1);else{let ee=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer[Y];s.bindRenderbuffer(s.RENDERBUFFER,X),s.framebufferRenderbuffer(s.FRAMEBUFFER,ee,s.RENDERBUFFER,X)}}else{let Y=A.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=s.createRenderbuffer(),Re(x.__webglDepthbuffer,A,!1);else{let ee=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,X),s.framebufferRenderbuffer(s.FRAMEBUFFER,ee,s.RENDERBUFFER,X)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function et(A,x,k){let Y=n.get(A);x!==void 0&&le(Y.__webglFramebuffer,A,A.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),k!==void 0&&Oe(A)}function P(A){let x=A.texture,k=n.get(A),Y=n.get(x);A.addEventListener("dispose",C);let ee=A.textures,X=A.isWebGLCubeRenderTarget===!0,we=ee.length>1;if(we||(Y.__webglTexture===void 0&&(Y.__webglTexture=s.createTexture()),Y.__version=x.version,a.memory.textures++),X){k.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer[ae]=[];for(let Se=0;Se<x.mipmaps.length;Se++)k.__webglFramebuffer[ae][Se]=s.createFramebuffer()}else k.__webglFramebuffer[ae]=s.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer=[];for(let ae=0;ae<x.mipmaps.length;ae++)k.__webglFramebuffer[ae]=s.createFramebuffer()}else k.__webglFramebuffer=s.createFramebuffer();if(we)for(let ae=0,Se=ee.length;ae<Se;ae++){let Ee=n.get(ee[ae]);Ee.__webglTexture===void 0&&(Ee.__webglTexture=s.createTexture(),a.memory.textures++)}if(A.samples>0&&Me(A)===!1){k.__webglMultisampledFramebuffer=s.createFramebuffer(),k.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let ae=0;ae<ee.length;ae++){let Se=ee[ae];k.__webglColorRenderbuffer[ae]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,k.__webglColorRenderbuffer[ae]);let Ee=r.convert(Se.format,Se.colorSpace),se=r.convert(Se.type),fe=y(Se.internalFormat,Ee,se,Se.colorSpace,A.isXRRenderTarget===!0),Ne=Ze(A);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ne,fe,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ae,s.RENDERBUFFER,k.__webglColorRenderbuffer[ae])}s.bindRenderbuffer(s.RENDERBUFFER,null),A.depthBuffer&&(k.__webglDepthRenderbuffer=s.createRenderbuffer(),Re(k.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(X){t.bindTexture(s.TEXTURE_CUBE_MAP,Y.__webglTexture),J(s.TEXTURE_CUBE_MAP,x);for(let ae=0;ae<6;ae++)if(x.mipmaps&&x.mipmaps.length>0)for(let Se=0;Se<x.mipmaps.length;Se++)le(k.__webglFramebuffer[ae][Se],A,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Se);else le(k.__webglFramebuffer[ae],A,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(x)&&p(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(we){for(let ae=0,Se=ee.length;ae<Se;ae++){let Ee=ee[ae],se=n.get(Ee),fe=s.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(fe=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(fe,se.__webglTexture),J(fe,Ee),le(k.__webglFramebuffer,A,Ee,s.COLOR_ATTACHMENT0+ae,fe,0),m(Ee)&&p(fe)}t.unbindTexture()}else{let ae=s.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ae=A.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ae,Y.__webglTexture),J(ae,x),x.mipmaps&&x.mipmaps.length>0)for(let Se=0;Se<x.mipmaps.length;Se++)le(k.__webglFramebuffer[Se],A,x,s.COLOR_ATTACHMENT0,ae,Se);else le(k.__webglFramebuffer,A,x,s.COLOR_ATTACHMENT0,ae,0);m(x)&&p(ae),t.unbindTexture()}A.depthBuffer&&Oe(A)}function Ye(A){let x=A.textures;for(let k=0,Y=x.length;k<Y;k++){let ee=x[k];if(m(ee)){let X=v(A),we=n.get(ee).__webglTexture;t.bindTexture(X,we),p(X),t.unbindTexture()}}}let De=[],Ae=[];function ge(A){if(A.samples>0){if(Me(A)===!1){let x=A.textures,k=A.width,Y=A.height,ee=s.COLOR_BUFFER_BIT,X=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,we=n.get(A),ae=x.length>1;if(ae)for(let Ee=0;Ee<x.length;Ee++)t.bindFramebuffer(s.FRAMEBUFFER,we.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,we.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,we.__webglMultisampledFramebuffer);let Se=A.texture.mipmaps;Se&&Se.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,we.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,we.__webglFramebuffer);for(let Ee=0;Ee<x.length;Ee++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(ee|=s.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(ee|=s.STENCIL_BUFFER_BIT)),ae){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,we.__webglColorRenderbuffer[Ee]);let se=n.get(x[Ee]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,se,0)}s.blitFramebuffer(0,0,k,Y,0,0,k,Y,ee,s.NEAREST),l===!0&&(De.length=0,Ae.length=0,De.push(s.COLOR_ATTACHMENT0+Ee),A.depthBuffer&&A.resolveDepthBuffer===!1&&(De.push(X),Ae.push(X),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Ae)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,De))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ae)for(let Ee=0;Ee<x.length;Ee++){t.bindFramebuffer(s.FRAMEBUFFER,we.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.RENDERBUFFER,we.__webglColorRenderbuffer[Ee]);let se=n.get(x[Ee]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,we.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ee,s.TEXTURE_2D,se,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,we.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){let x=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[x])}}}function Ze(A){return Math.min(i.maxSamples,A.samples)}function Me(A){let x=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Ve(A){let x=a.render.frame;h.get(A)!==x&&(h.set(A,x),A.update())}function Tt(A,x){let k=A.colorSpace,Y=A.format,ee=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||k!==Ct&&k!==Kn&&(Ke.getTransfer(k)===it?(Y!==Kt||ee!==_n)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",k)),x}function gt(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=B,this.setTexture2D=j,this.setTexture2DArray=N,this.setTexture3D=W,this.setTextureCube=F,this.rebindTextures=et,this.setupRenderTarget=P,this.updateRenderTargetMipmap=Ye,this.updateMultisampleRenderTarget=ge,this.setupDepthRenderbuffer=Oe,this.setupFrameBufferTexture=le,this.useMultisampledRTT=Me}function kb(s,e){function t(n,i=Kn){let r,a=Ke.getTransfer(i);if(n===_n)return s.UNSIGNED_BYTE;if(n===Oa)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Ba)return s.UNSIGNED_SHORT_5_5_5_1;if(n===wc)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Ac)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===Ec)return s.BYTE;if(n===Tc)return s.SHORT;if(n===bs)return s.UNSIGNED_SHORT;if(n===Fa)return s.INT;if(n===oi)return s.UNSIGNED_INT;if(n===nn)return s.FLOAT;if(n===_s)return s.HALF_FLOAT;if(n===Rc)return s.ALPHA;if(n===Cc)return s.RGB;if(n===Kt)return s.RGBA;if(n===ts)return s.DEPTH_COMPONENT;if(n===vs)return s.DEPTH_STENCIL;if(n===ka)return s.RED;if(n===za)return s.RED_INTEGER;if(n===Pc)return s.RG;if(n===Ha)return s.RG_INTEGER;if(n===Ga)return s.RGBA_INTEGER;if(n===mr||n===gr||n===br||n===_r)if(a===it)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===mr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===gr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===br)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===_r)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===mr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===gr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===br)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===_r)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Va||n===Wa||n===qa||n===Xa)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Va)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Wa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===qa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Xa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ja||n===Ka||n===Ya)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ja||n===Ka)return a===it?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Ya)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ja||n===Za||n===$a||n===Qa||n===eo||n===to||n===no||n===io||n===so||n===ro||n===ao||n===oo||n===co||n===lo)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ja)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Za)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===$a)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Qa)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===eo)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===to)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===no)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===io)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===so)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ro)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ao)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===oo)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===co)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===lo)return a===it?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ho||n===uo||n===fo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===ho)return a===it?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===uo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===fo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===po||n===mo||n===go||n===bo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===po)return r.COMPRESSED_RED_RGTC1_EXT;if(n===mo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===go)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===bo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===xs?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}var zb=`
void main() {
...
`+J.fragmentShader,J.fragmentShader=J.fragmentShader.replace("#include <roughnessmap_fragment>",`#include <roughnessmap_fragment>
  ...
  `)},m.customProgramCacheKey=()=>"meatwash-paint-v2";let y=[],_=new Set;c.traverse(J=>{if(!J.isMesh)return;J.castShadow=!0,J.receiveShadow=!0;let ne=J.material;if(["material_0","930_wunderbaum"].includes(ne.name)){J.visible=!1;return}ne.name==="paint"?(m.aoMap=ne.aoMap,m.aoMapIntensity=.7,J.material=m,_.add(ne)):ne.name==="coat"?J.visible=!1:ne.name==="glass"?(J.material=new mt({color:"#d5d8d3",metalness:0,roughness:.055,transmission:.94,thickness:.004,ior:1.52,transparent:!0,opacity:1,depthWrite:!1,envMapIntensity:.7}),y.push(J)):ne.name==="black"?(ne.color.set("#0b0908"),ne.roughness=.82,ne.metalness=0):ne.name==="930_plastics"?(ne.color.set("#827265"),ne.roughness=.6,ne.metalness=.03):ne.name==="930_chromes"?(ne.color.set("#d6cec2"),ne.roughness=.18,ne.metalness=1,ne.envMapIntensity=1.2):ne.name==="930_tire"?(ne.color.set("#38322d"),ne.roughness=.93,ne.metalness=0):ne.name==="930_rim"?(ne.roughness=.23,ne.envMapIntensity=1.2):ne.name==="930_lights"?(ne.color.setRGB(1.5,1.5,1.5),ne.roughness=.16,ne.metalness=.65):ne.name==="930_lights_refraction"&&(J.material=new mt({color:"#ffffff",roughness:.13,metalness:.2,transmission:.45,thickness:.004,ior:1.52})),J.material.map&&(J.material.map.anisotropy=Math.min(4,n.capabilities.getMaxAnisotropy()))});let T=Qu(i,c);T.name="Clean leather cockpit",i_(T);let w=c.getObjectByName("Object_130")?.material;c.traverse(J=>{J.isMesh&&J.material.ior===1.52&&!y.includes(J)&&w?.normalMap&&(J.material.normalMap=w.normalMap,J.material.map=w.map,J.material.color.setRGB(2.1,2.1,2.1))});let C=td(i,c.getObjectByName("Object_30"),t());s.dataset.setupMs=String(Math.round(performance.now()-e)),n.shadowMap.autoUpdate=!1,n.shadowMap.needsUpdate=!0;let D=0,S=0,M=0,I=!1,B=0,z=0,V=[],j=[],N=J=>J.length?[...J].sort((ne,Fe)=>ne-Fe)[Math.floor(J.length/2)]:0,W=new R,F=new R,Z=new R;function K(){let{width:J,height:ne}=s.parentElement.getBoundingClientRect();S=J,M=ne,n.setSize(J,ne,!1),n.setPixelRatio(Math.min(devicePixelRatio,t()?1:1.25)),r.aspect=J/ne}function ce(J,ne=!1){if(I||document.hidden)return;D=J,(!S||ne)&&K();let Fe=Ll(J)*5,be=Math.min(4,Math.floor(Fe)),q=Ft(Fe-be,.13,.87),$=Sr[be],le=Sr[be+1],Re=Math.atan2($.p[0],$.p[2]),pe=Math.atan2(le.p[0],le.p[2])-Re;pe>Math.PI&&(pe-=Math.PI*2),pe<-Math.PI&&(pe+=Math.PI*2);let Oe=Re+pe*q,et=sn.lerp(Math.hypot($.p[0],$.p[2]),Math.hypot(le.p[0],le.p[2]),q);if(W.set(Math.sin(Oe)*et,sn.lerp($.p[1],le.p[1],q),Math.cos(Oe)*et),F.fromArray($.t).lerp(Z.fromArray(le.t),q),r.fov=sn.lerp($.f,le.f,q),t()){let Ze=Ft(J,.04,.18)*(1-Ft(J,.88,.98));W.sub(F).multiplyScalar(sn.lerp(1.65,1.18,Ze)).add(F),r.fov=sn.lerp(42,55,Ze),r.setViewOffset(S,M,0,M*.18,S,M)}else r.setViewOffset(S,M,-S*.12,0,S,M);r.position.copy(W),r.lookAt(F),r.updateProjectionMatrix();let P=Ft(J,.3,.37)*(1-Ft(J,.44,.5));y.forEach(Ze=>Ze.material.opacity=1-P*.985);let Ye=Ft(J,.535,.653),De=Ft(J,.47,.52)*(1-Ft(J,.68,.7));p.value=1-De*(1-Ye),v.value=Ft(J,.095,.245),m.roughness=sn.lerp(.21,.13,Ye),m.clearcoatRoughness=sn.lerp(.065,.026,Ye),o.reflectionLight.position.set(sn.lerp(-1,2.4,Ye),2.5,-1.3),C.update(J);let Ae=performance.now();n.render(i,r);let ge=performance.now()-Ae;V.push(ge),V.length>60&&V.shift(),z&&Ae-z<200&&(j.push(Ae-z),j.length>60&&j.shift()),z=Ae,++B%30===0&&(s.dataset.renderMs=N(V).toFixed(1),s.dataset.frameMs=N(j).toFixed(1),s.dataset.drawCalls=String(n.info.render.calls),s.dataset.textures=String(n.info.memory.textures)),s.dataset.ready="true",s.dataset.progress=J.toFixed(4)}return K(),r.position.fromArray(Sr[0].p),r.lookAt(new R(...Sr[0].t)),r.updateProjectionMatrix(),await n.compileAsync(i,r),s.dataset.compileMs=String(Math.round(performance.now()-e)),ce(0,!0),{update:ce,resize:()=>ce(D,!0),stats:()=>({drawCalls:n.info.render.calls,triangles:n.info.render.triangles,textures:n.info.memory.textures,geometries:n.info.memory.geometries}),dispose(){if(I)return;I=!0,C.dispose(),o.dispose();let J=new Set,ne=new Set,Fe=new Set;i.traverse(be=>{if(be.geometry&&Fe.add(be.geometry),be.material)for(let q of Array.isArray(be.material)?be.material:[be.material])ne.add(q),Object.values(q).forEach($=>{$?.isTexture&&J.add($)})}),J.forEach(be=>be.dispose()),ne.forEach(be=>be.dispose()),Fe.forEach(be=>be.dispose()),_.forEach(be=>be.dispose()),n.dispose()}}}function i_(s){s.updateMatrixWorld(!0);let e=new Map;s.traverse(t=>{if(!t.isMesh||Array.isArray(t.material))return;let n=t.material.uuid;e.has(n)||e.set(n,[]),e.get(n).push(t)});for(let t of e.values()){if(t.length<2)continue;let n=t.map(a=>{let o=a.geometry.index?a.geometry.toNonIndexed():a.geometry.clone();o.applyMatrix4(a.matrixWorld);for(let l of Object.keys(o.attributes))["position","normal","uv"].includes(l)||o.deleteAttribute(l);return o}),i=Xu(n);if(n.forEach(a=>a.dispose()),!i)continue;let r=new qe(i,t[0].material);r.castShadow=r.receiveShadow=!0,t.forEach(a=>{a.removeFromParent(),a.geometry.dispose()}),s.add(r)}}export{av as createScene};
