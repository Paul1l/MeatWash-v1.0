...
- **Onest** — геометрический гротеск с кириллицей от Paratype-школы: круглые
  овалы и прямые окончания рифмуются с капсулами знака. Веса 300–900.
- **JetBrains Mono** — технический контрапункт: надзаголовки, номера шагов,
  индексы программ. Даёт «инженерность», которой ждут от детейлинга.
