...
<section class="catalog" id="services" aria-labelledby="catalog-title">
 <div class="catalog__heading"><div><p class="eyebrow" lang="en">MEATWASH / CAR CARE</p><h2 id="catalog-title">Искусство ухода.<br>В деталях.</h2></div><p>Пять программ мойки и весь спектр детейлинга. Выберите уход под состояние автомобиля — от регулярной мойки до восстановления и защиты.</p></div>
 ...
 <div class="catalog__section" id="price-list">
  <div class="catalog__aside"><span class="eyebrow" lang="en">02 / DETAILING</span><h3>Услуги<br> и цены</h3><p>39 работ в восьми направлениях. Дополните программу мойки или запишитесь на отдельную услугу.</p><a class="link-arrow" href="#locations">Выбрать локацию ↗</a></div>
